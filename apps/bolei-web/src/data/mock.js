export const ALL_PLAYERS = [
  ...
  { id: 'p2',  nick: 'Everson',         pos: 'GOL', club: 'Atlético-MG', pts: 11.5, avg: 10.3, status: 'bench'     },
  { id: 'p3',  nick: 'Santos',          pos: 'GOL', club: 'Flamengo',    pts:  9.3, avg:  8.7, status: 'injured'   },
  { id: 'p4',  nick: 'Nino',            pos: 'ZAG', club: 'Fluminense',  pts: 10.4, avg:  9.8, status: 'probable'  },
  { id: 'p5',  nick: 'Léo Pereira',     pos: 'ZAG', club: 'Flamengo',    pts: 12.1, avg: 11.0, status: 'probable'  },
  { id: 'p6',  nick: 'Murillo',         pos: 'ZAG', club: 'Corinthians', pts:  8.6, avg:  7.9, status: 'bench'     },
  { id: 'p7',  nick: 'Gilberto',        pos: 'LAT', club: 'Fluminense',  pts: 11.3, avg: 10.1, status: 'probable'  },
  { id: 'p8',  nick: 'Varela',          pos: 'LAT', club: 'Flamengo',    pts: 13.5, avg: 12.4, status: 'probable'  },
  { id: 'p9',  nick: 'Dodô',            pos: 'LAT', club: 'São Paulo',   pts:  9.2, avg:  8.5, status: 'bench'     },
  { id: 'p10', nick: 'Gerson',          pos: 'MEI', club: 'Flamengo',    pts: 16.3, avg: 14.8, status: 'probable'  },
  { id: 'p11', nick: 'De Arrascaeta',   pos: 'MEI', club: 'Flamengo',    pts: 18.7, avg: 17.2, status: 'probable'  },
  { id: 'p12', nick: 'Raphael Veiga',   pos: 'MEI', club: 'Palmeiras',   pts: 15.2, avg: 14.1, status: 'probable'  },
  { id: 'p13', nick: 'Scarpa',          pos: 'MEI', club: 'Atlético-MG', pts: 13.8, avg: 12.5, status: 'probable'  },
  { id: 'p14', nick: 'Rodrigo Garro',   pos: 'MEI', club: 'Corinthians', pts: 14.1, avg: 13.0, status: 'bench'     },
  { id: 'p15', nick: 'Hulk',            pos: 'ATA', club: 'Atlético-MG', pts: 17.5, avg: 16.0, status: 'probable'  },
  { id: 'p16', nick: 'Endrick',         pos: 'ATA', club: 'Palmeiras',   pts: 14.8, avg: 13.5, status: 'probable'  },
  { id: 'p17', nick: 'Pedro',           pos: 'ATA', club: 'Flamengo',    pts: 19.2, avg: 18.1, status: 'probable'  },
  { id: 'p18', nick: 'Cano',            pos: 'ATA', club: 'Fluminense',  pts: 13.1, avg: 12.3, status: 'suspended' },
  { id: 'p19', nick: 'Rony',            pos: 'ATA', club: 'Palmeiras',   pts: 11.2, avg: 10.5, status: 'bench'     },
  { id: 'p20', nick: 'Luciano',         pos: 'ATA', club: 'São Paulo',   pts: 12.5, avg: 11.8, status: 'probable'  },
  { id: 'p21', nick: 'Calleri',         pos: 'ATA', club: 'São Paulo',   pts: 10.8, avg:  9.9, status: 'bench'     },
  { id: 'p22', nick: 'Mostarda',        pos: 'MEI', club: 'Grêmio',      pts:  8.3, avg:  7.8, status: 'bench'     },
  { id: 'p23', nick: 'Suárez',          pos: 'ATA', club: 'Grêmio',      pts: 16.1, avg: 15.0, status: 'probable'  },
  { id: 'p24', nick: 'Alan Patrick',    pos: 'MEI', club: 'Inter',       pts: 14.5, avg: 13.8, status: 'probable'  },
  { id: 'p25', nick: 'Bremer',          pos: 'ZAG', club: 'Juventus',    pts:  9.7, avg:  9.0, status: 'bench'     },
  { id: 'p26', nick: 'Militão',         pos: 'ZAG', club: 'Real Madrid', pts: 10.3, avg:  9.5, status: 'probable'  },
  { id: 'p27', nick: 'Alex Sandro',     pos: 'LAT', club: 'Flamengo',    pts:  8.1, avg:  7.5, status: 'injured'   },
  { id: 'p28', nick: 'Raphinha',        pos: 'ATA', club: 'Barcelona',   pts: 15.6, avg: 14.8, status: 'probable'  },
  { id: 'p29', nick: 'Rodrygo',         pos: 'ATA', club: 'Real Madrid', pts: 14.2, avg: 13.5, status: 'probable'  },
  { id: 'p30', nick: 'Vinícius Jr',     pos: 'ATA', club: 'Real Madrid', pts: 22.3, avg: 20.8, status: 'probable'  },
];
